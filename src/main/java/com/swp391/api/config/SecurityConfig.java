    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/payments/orders/*/sepay").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/payments/orders/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/payments/orders/*/latest").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/menu", "/api/menu/**", "/api/menu-categories", "/api/menu-categories/**")
                        .hasAnyRole("ADMIN", "MANAGER", "WAITER", "RECEPTIONIST")
